...
export default function AlertTicketDelete({ title, open, handleClose }: Props) {
  return (
    <Dialog
      open={open}
      ...
      aria-describedby="ticket-delete-description"
    >
        ...
        <Stack sx={{ gap: 3.5, alignItems: 'center' }}>
          ...
          <Stack sx={{ gap: 2 }}>
            ...
            <Typography align="center">
              ...
              ticket, all its details and history will be permanently removed.
            </Typography>
          </Stack>
