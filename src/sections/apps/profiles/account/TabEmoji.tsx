      ...
      <Grid size={12}>
        <MainCard title="Personaliza tu avatar">
          <Stack spacing={2}>
            ...
            <div>
              <Button variant="outlined" onClick={startCamera} disabled={streamActive}>
                Abrir cámara
              </Button>
              <Button variant="contained" onClick={takePhoto} disabled={!streamActive}>
                Tomar foto
              </Button>
            </div>
            ...
            <Stack direction="row" spacing={2}>
              ...
              <Button variant="outlined" onClick={generateWithDicebear}>
                Generar con DiceBear
              </Button>
            </Stack>
          </Stack>
        </MainCard>
              ...
              <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
                {Object.entries(dicebearElements).map(([k, svg]) => (
                  <div key={k} style={{ width: 120, textAlign: 'center' }}>
                    <div
                      style={{ width: 120, height: 120, border: '1px solid #eee', padding: 6, borderRadius: 6 }}
